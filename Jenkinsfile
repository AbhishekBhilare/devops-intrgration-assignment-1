        ...
        stage ('Docker Image->Docker Hub'){
            steps {
                script {
                    ...
                    bat 'docker tag devops-assignment-02:abhishekbhilare/my-app-1.0-snapshot 272814864966.dkr.ecr.us-east-1.amazonaws.com/devops-assignment-02:abhishekbhilare/my-app-1.0-snapshot'
                    //for ecr
